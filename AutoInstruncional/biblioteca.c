...
void cadastrarLimite(cliente *cliente, int idade){
	...
	if(tipo = 'U'){
		...
		if(idade > 18 && idade < 40){
			cliente->limite = 10000 + (10000 * 0,05);
		}
		else if(idade > 41 && idade < 60){
			cliente->limite = 15000 + (15000 * 0,05);
		}
		else if(idade > 61 && idade < 75){
			cliente->limite = 5000 + (5000* 0.05);
		}
		else if(idade > 75){	
			cliente->limite = 2500 + (2500 * 0.05) ;
		}
	}
	else if(tipo = 'I'){

		if(idade > 18 && idade < 40){
			cliente->limite = 10000 + (10000 * 0,2);
		}
		else if(idade > 41 && idade < 60){
			cliente->limite = 15000 + (15000 * 0,2);
		}
		else if(idade > 61 && idade < 75){
			cliente->limite = 5000 + (5000* 0.2);
		}
		else if(idade > 75){	
			cliente->limite = 2500 + (2500 * 0.2) ;
		}
	}	
}
...
void cadastrarQtdeDependente(cliente *cliente) {
	...
	do {
		...
		if (quantDependentes > 2) {
			printf(" Digite novamenta, maximo de dependentes alcancado.");
		}
	} while (quantDependentes > 2);
	
	dep = cliente->dependentes;
	
	
	cliente->dependentes = quantDependentes;
...
int exibirDadosComMedia(cliente *cliente){
	
	if(cliente->proximo=='\0')
		return 0;
	else
		return exibirDadosComMedia(cliente);
}
